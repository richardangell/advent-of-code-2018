...
def alchemical_reduction_better(file):
    ...
    for l in letters:
        ...
        polymer_copy = polymer_copy.replace(l, '')

        polymer_copy = polymer_copy.replace(l.upper(), '')

        results.append(alchemical_reduction(polymer_copy))

    min_length_polymer = min(results)

    print(min_length_polymer)
...
if __name__ == '__main__':
    ...
    alchemical_reduction_better(sys.argv[1])
